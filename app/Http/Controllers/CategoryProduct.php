...
class CategoryProduct extends Controller
{
    ...
    public function get_all_category_product()
    {
        ...
        //$get_all_category_product = DB::table('tbl_category_product')->get();
        $manager_category_product = view('admin.get_all_category_product')->with('get_all_category_product', $get_all_category_product);
        return view('admin_layout')->with('admin.get_all_category_product', $manager_category_product);
    }
    ...
    public function save_category_product(Request $request)
    {
        ...
        $data['category_orders'] = $request->category_orders;
    ...
    public function show_category_home(Request $request, $category_id)
    {
        ...
        $brand_product = DB::table('tbl_brand')->where('brand_status', '1')->orderByDesc('brand_id')->get();
        $category_name = DB::table('tbl_category_product')->where('tbl_category_product.category_id', $category_id)->first();
        $category_by_id = DB::table('tbl_product')
            ->join('tbl_category_product', 'tbl_category_product.category_id', '=', 'tbl_product.category_id')->where('tbl_product.category_id', $category_id)->get();
