    ...
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <form action="{{ URL::to('/register') }}" method="post">
                {{ csrf_field() }}
                <input type="text" class="ggg" name="admin_name" placeholder="Điền tên đăng nhập" required>
                <input type="email" class="ggg" name="admin_email" placeholder="Điền Email" required>
                <input type="text" class="ggg" name="admin_phone" placeholder="Điền số điện thoại" required>
            ...
            <a href="{{ URL::to('/login-facebook') }}">Login Google</a>
